...
So far we have only looked at words individually, and how those words relate to sentiment or frequency in doccuments. But what if we want to know about how words relate to each other in a text? This can be accomplished though n-grams, where n is a number. 
